...
In order to run this project on a single instance, firstly, one needs to be in the flowshopWCT folder within the terminal. Then, the following command will run the project on a single instance : 
		
		make && ./flowshopWCT <path/to/instance_file> <IGA/Tabu> <random/srz>
